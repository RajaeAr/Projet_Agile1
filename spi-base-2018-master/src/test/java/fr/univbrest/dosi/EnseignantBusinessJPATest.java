...
public class EnseignantBusinessJPATest {
	...
	public void doitCreerUnEnseignant() {
		...
		Enseignant enseignant1ACreer = new Enseignant(7,"arhoune.rajae@gmail.com", "ARHOUNE", "Rajae") ;
		Enseignant enseignant2ACreer = new Enseignant(8,"safae.arh@gmail.com", "ARH", "Safae") ;
	...
	public void doitChercherUnEnseignantParNom() {
		...
		Enseignant enseignant2ACreer = new Enseignant(8,"safae.arh@gmail.com", "ARH", "Safae") ;
		 business.creerEnseignant(enseignant1ACreer);
		 business.creerEnseignant(enseignant2ACreer);
		 List<Enseignant> resultat= business.RechercherParNomEnseignant("ARHOUNE");
			assertThat(resultat.get(0).getPrenom()).isEqualTo("Rajae");
	}
}
